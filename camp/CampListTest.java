...
public class CampListTest {
    ...
    public void setUp() throws ParseException {
        ...
        UUID campUUID = UUID.fromString("24d02b77-3ce4-4765-b3a8-79e0cfe22a11");
        campList.add(new Camp(campUUID, "247", sessionList, 500.50, faqs, 8.0, campActivities));
    ...
    void testGetCampUUIDFirstItem() {
        Camp first = camps.getCamp(UUID.fromString("24d02b77-3ce4-4765-b3a8-79e0cfe22a11"));
        assertSame(first, campList.get(0));
    }

    @Test
    void testGetCampUUIDBlank() {
        Camp blank = camps.getCamp(UUID.fromString("00000000-0000-0000-0000-000000000000"));
        assertSame(blank, null);
    }

    @Test
    void testGetCampUUIDName() {
        String CampName = camps.getCamp(UUID.fromString("24d02b77-3ce4-4765-b3a8-79e0cfe22a11")).getName();
        assertSame(CampName, "247");
    }

    @Test
    void testGetCampUUIDFAQS() {
        ArrayList<FAQ> CampFAQ = camps
                .getCamp(UUID.fromString("24d02b77-3ce4-4765-b3a8-79e0cfe22a11")).getFAQs();
        assertSame(CampFAQ, campList.get(0).getFAQs());
    }

    @Test
    void testGetCampUUIDPrice() {
        Double CampPrice = camps.getCamp(UUID.fromString("24d02b77-3ce4-4765-b3a8-79e0cfe22a11"))
                .getPrice();
        assertEquals(CampPrice, 500.50);
    }
}
