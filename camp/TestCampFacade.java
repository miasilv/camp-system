...
public class TestCampFacade {
    ...
    // ***************************** CAMP CLASS *********************************************************
    @Test
    public void testRemoveCampFAQ() {
        boolean isRemoved;
        isRemoved = camp.removeFAQ(0);    
        assertFalse(isRemoved);
    }

    @Test
    public void testAddCampFAQ() {
    ...
    public void testValidCounselorSignIn() {
        String email = userList.getCounselors().get(0).getEmail();
