...
public class UserListTest {
    ...
    public void setUp() throws ParseException {
         ...
         * director
         */
        UUID dirUUID = UUID.fromString("24d02b77-3ce4-4765-b3a8-79e0cfe22a11");
        directorList
                .add(new Director(dirUUID, "bob wright", "bobwright88@yahoo.com", "password", "8045569988"));
        ...
        UUID guardUUID = UUID.fromString("8e99955f-d23e-40a0-b693-231c42f41f09");
        guardianList.add(new Guardian(guardUUID, "Karen Smith", "karensmith@gmail.com", "password",
        ...
        sessionList.add(
                new Session(UUID.randomUUID(), "cheetah girls", session1Cabins, "lets go girls", startDate, endDate));
    ...
    @Test
    void testGetUserEmailDirector() {
        User dir = users.getUser("bobwright88@yahoo.com");
        assertSame(dir, (User)directorList.get(0));
    }

    @Test
    void testGetUserEmailGuardian() {
        User guard = users.getUser("karensmith@gmail.com");
        assertSame(guard, (User)guardianList.get(0));
    }

    @Test
    void testGetUserEmailNull() {
        User n = users.getUser("null");
        assertSame(n, null);
    }

    @Test
    void testGetUserEmailInvalid() {
        User invalid = users.getUser("invalid email string here");
        assertSame(invalid, null);
    }

    @Test
    void testGetUserEmailEmpty() {
        User empty = users.getUser("");
        assertSame(empty, null);
    }

    @Test
    void testGetUserEmailWrongFormat() {
        User wrongFormat = users.getUser("a;lsdkjf;las");
    ...
    void testGetUserUUIDDirector() {
        User dir = users.getUser(UUID.fromString("24d02b77-3ce4-4765-b3a8-79e0cfe22a11"));
        assertSame(dir, (User) directorList.get(0));
    }

    @Test
    void testGetUserUUIDGuardian() {
