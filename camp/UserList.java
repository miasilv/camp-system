...
public class UserList {
    ...
    /**
     * Accesses a counselor based on email
     * @param email The email of the counselor
     * @return The counselor with that email
     */
    ...
    /**
     * Accesses a guardian based on email
     * @param email The email of the guardian
     * @return The guardian with that email
     */
    ...
    /**
     * Accesses the counselor based on UUID
     * @param id The UUID of the counselor
    ...
    /**
     * Accesses the guardian based on UUID
     * @param id The UUID of the guardian
     * @return The guardian with that UUID
     */
    ...
    /**
     * Removes a counselor based on email
    ...
    /**
     * Removes guardian based on email
