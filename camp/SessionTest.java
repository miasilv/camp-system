...
public class SessionTest {
	...
	public void setup() throws ParseException {
        ...
        @Test
        public void testRemoveCabinValidIndex(){
            assertFalse(cabinList.contains(cabinList.remove(0)));
        }

        @Test
        public void testRemoveCabinInvalidIndex(){
            assertNull(cabinList.remove(0));
        }

        @Test
        public void testAddCabinValidCabin(){
            Cabin cabin = new Cabin(2, 4);
            assertTrue(cabinList.contains(cabinList.add(cabin)));
        }

        @Test
        public void testAddCabinValidCabinNotInList(){
            Cabin cabin = new Cabin(2, 4);
            assertTrue(cabinList.contains(cabin));
        }

        @Test
        public void testAddCabinNullCabin(){
            Cabin cabin = null;
            assertTrue(cabinList.contains(cabinList.add(cabin)));
        }

        @Test
        public void testRemoveCabinbyCabinValidCabin(){
            Cabin cabin = new Cabin(2, 4);
            cabinList.add(cabin);
            cabinList.remove(cabin);
            assertFalse(cabinList.contains(cabin));
        }
